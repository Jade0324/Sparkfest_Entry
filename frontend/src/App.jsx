...
export default function App() {
  ...
  // where LearningSession should return to when done: 'wordPicker' | 'home'
  ...
  const handlePracticeWord = async (exerciseId) => {
    try {
      ...
      // fallback — at least go home so user isn't stuck
      setCurrentScreen('home');
    }
  };

  // where LearningSession sends the user after the summary
  const afterSession = () =>
