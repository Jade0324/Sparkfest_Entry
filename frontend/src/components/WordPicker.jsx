...
// Average accuracy across whatever levels have been attempted for this exercise.
// Reads localStorage.levelHistory — shape:
// { [exerciseId]: { targetWord, ..., levels: { "0": { accuracy }, "1": ..., "2": ... } } }
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // endpoint returns a Page → read .content (fall back to bare array just in case)
